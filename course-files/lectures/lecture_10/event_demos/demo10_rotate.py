...
make_creature(canvas, (400, 400), tag='c2')
make_creature(canvas, (600, 50), tag='c3')
utilities.rotate(canvas, 'c2', degrees=-60, origin=(400, 400))
utilities.rotate(canvas, 'c3', degrees=110, origin=(600, 50))
