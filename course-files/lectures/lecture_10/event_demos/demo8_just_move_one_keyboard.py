...
canvas.create_text(
    ...
    text='1. Click anywhere to create a circle. \n2. Right click to select a circle. \n3. Use arrow keys to move a circle', 
    font=("Purisa", 32),
    width=600
)
...
def move_circle(event):
    if active_tag is None:
        print('No active shape selected. Right-click shape to activate it.')
        return
    distance = 10
