...
def get_perimeter(side_a: float, side_b: float):
    ...
    Returns: 
        float: the perimeter
    '''
    # TODO: replace the "return None" statement with code that returns the 
    # perimeter of a right triangle. Hint: use the get_hypotenuse funciton 
    # as part of your answer
    return side_a + side_b + get_hypotenuse(side_a, side_b)
